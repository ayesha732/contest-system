...
export interface ApiContestContest extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    isDeleted: Schema.Attribute.Boolean &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<false>;
    leaderboards: Schema.Attribute.Relation<
      'oneToMany',
    ...
    > &
      Schema.Attribute.Private;
    maxParticipants: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<0>;
    ...
    prizeDetails: Schema.Attribute.Text;
...
export interface ApiLeaderboardLeaderboard extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    prizeAwarded: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
    prizeDetails: Schema.Attribute.Text;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiPrizePrize extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    awardedAt: Schema.Attribute.DateTime;
    contest: Schema.Attribute.Relation<'manyToOne', 'api::contest.contest'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ...
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::prize.prize'> &
      Schema.Attribute.Private;
    prizeDetails: Schema.Attribute.Text & Schema.Attribute.Required;
    publishedAt: Schema.Attribute.DateTime;
    rank: Schema.Attribute.Integer;
    status: Schema.Attribute.Enumeration<['pending', 'awarded', 'claimed']> &
      Schema.Attribute.DefaultTo<'awarded'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    user: Schema.Attribute.Relation<
...
export interface ApiQuestionQuestion extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    questionType: Schema.Attribute.Enumeration<
      ['single_select', 'multi_select', 'true_false']
    > &
      Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
...
export interface ApiUserAnswerUserAnswer extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    participation: Schema.Attribute.Relation<
      'manyToOne',
      'api::user-contest-participation.user-contest-participation'
    >;
...
export interface ApiUserContestParticipationUserContestParticipation
  extends Struct.CollectionTypeSchema {
  collectionName: 'user_contest_participations';
  info: {
    displayName: 'User Contest Participation';
    pluralName: 'user-contest-participations';
    singularName: 'user-contest-participation';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    participationStatus: Schema.Attribute.Enumeration<
      ['joined', 'submitted', 'in_progess', 'completed']
    > &
      Schema.Attribute.DefaultTo<'joined'>;
    publishedAt: Schema.Attribute.DateTime;
    startTime: Schema.Attribute.DateTime;
    submittedAt: Schema.Attribute.DateTime;
    totalScore: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<0>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    user: Schema.Attribute.Relation<
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::user-contest-participation.user-contest-participation': ApiUserContestParticipationUserContestParticipation;
